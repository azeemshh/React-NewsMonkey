...
export class News extends Component {
  ...
  updateNews = async () => {
    ...
    const url = `
    https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4f9ed993ea7b49b9bdcffd8b158d7bd1&page=${this.state.page}&pageSize=${this.props.pageSize}`;
